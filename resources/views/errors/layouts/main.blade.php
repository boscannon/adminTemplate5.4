                    ...
                    <div class="hero-inner">
                        <div class="content content-full">
                            <div class="py-30 text-center">
                                ...
                                <h2 class="h3 font-w400 text-muted mb-50">{{ $exception->getMessage() != '' ? $exception->getMessage() : __($message) }}</h2>
                                <a class="btn btn-hero btn-rounded btn-alt-secondary" href="javascript:history.back()">
                                    <i class="fa fa-arrow-left mr-10"></i> {{ __('back') }}
                                </a>
                                @if(Auth::check())
                                <a class="btn btn-hero btn-rounded btn-alt-danger"  href="javascript:void(0)" onclick="$('#form').submit()">
